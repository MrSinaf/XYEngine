...
public static unsafe partial class ImGui
{
	...
	public static bool InputText(ReadOnlySpan<char> label, ref string input, uint maxLength, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback)
	...
	public static bool InputTextMultiline(ReadOnlySpan<char> label, ref string input, uint maxLength, Vector2 size, ImGuiInputTextFlags flags)
	...
	private static Vector2 CalcTextSizeImpl(ReadOnlySpan<char> text, int start = 0, int? length = null, bool hideTextAfterDoubleHash = false,
	...
	public static bool InputText(ReadOnlySpan<char> label, IntPtr buf, uint bufSize, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback)
	...
	public static bool MenuItem(ReadOnlySpan<char> label, bool enabled) => MenuItem(label, string.Empty, false, enabled);
