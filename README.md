...
> Un template prêt à l'emploi pour XYEngine sera disponible à la sortie d'un **Release**.

## 🌐〉Site web

Pour plus d'informations, consultez la page dédiée du moteur sur [~~mon site web~~](https://sinafproduction.xyz/projects/xyengine).