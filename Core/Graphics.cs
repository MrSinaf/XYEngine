...
public static class Graphics
{
	...
	internal static void DrawMesh(Mesh mesh, Material material)
	{
		...
		gl.BindVertexArray(mesh.vertexArray.handle);
		unsafe
		{
			gl.DrawElements((PrimitiveType)material.topology, (uint)mesh.indices.Length, DrawElementsType.UnsignedInt, (void*)0);
		}
