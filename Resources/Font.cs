...
public unsafe class Font : IAsset
{
	...
	public FontBitmap GenerateBitmap(uint size, int bitmapSize = 1024)
	{
		...
		// Ajoute l'espace pour... espacer ;)
		FT_Load_Glyph(face, FT_Get_Char_Index(face, ' '), FT_LOAD.FT_LOAD_DEFAULT);
		// TODO: J'ai ajouté 0.75F, pour rendre l'espacement moins grand, car je le trouve très grand pour rien, il est clair que ce n'est pas la bonne méthode...
